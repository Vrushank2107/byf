        ...
        <div className="container-page grid gap-12 lg:grid-cols-[1fr_1.2fr]">
          ...
          <div>
            ...
            <form onSubmit={onSubmit} className="mt-8 grid gap-4 rounded-3xl border border-border bg-card p-6 shadow-soft md:p-8">
              ...
              <button
                type="submit"
                className="mt-2 inline-flex items-center justify-center gap-2 rounded-full gradient-warm px-7 py-3.5 font-display text-sm font-semibold text-white shadow-warm transition-transform hover:-translate-y-0.5"
              >
                Submit Application
              </button>
