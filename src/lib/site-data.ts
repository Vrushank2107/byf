...
export const MISSIONS = [
  {
    title: "Education",
    desc: "Putting books, notebooks and confidence into the hands of every child who wants to learn.",
    icon: "GraduationCap",
  },
  {
...
export const LEADERSHIP = [
  ...
  { name: "Karan Mehta", role: "Director, Volunteers", bio: "Manages the 450-strong volunteer community and youth programs." },
  { name: "Sneha Iyer", role: "Director, Outreach", bio: "Heads cultural programs, sponsor relations and donor stewardship." },
];
